...
void serialrx_init(); // SerialRX.ino
bool serialrx_update(); // SerialRX.ino
...
#endif // __AVR_ATmega168__ || defined(__AVR_ATmega168P__) ||  __AVR_ATmega328P__
...
#if defined(PWM_CHAN_PIN_SERIALRX)
